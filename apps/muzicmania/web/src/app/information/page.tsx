              ...
              <div className="p-10 rounded-[3rem] bg-doc-dark border border-white/5 hover:border-white/20 transition-all duration-500 hover:scale-[1.03] group shadow-xl">
                 <div className="flex flex-col xl:flex-row gap-8 items-center xl:items-start text-center xl:text-left">
                    <div className="w-32 h-32 relative flex-shrink-0 animate-float">
                       <Image src="/logos/imagen/not outline/isotipo/degradado/color/muzicmania_logo_isotipo_notoutline_degradado_color.svg" alt="Isotipo" fill className="object-contain drop-shadow-neon-blue" />
                    </div>
              ...
              <div className="p-10 rounded-[3rem] bg-doc-dark border border-white/5 hover:border-white/20 transition-all duration-500 hover:scale-[1.03] group shadow-xl">
                 <div className="flex flex-col gap-8 items-center text-center">
                    <div className="w-full max-w-[280px] h-32 relative flex-shrink-0">
                       <Image src="/logos/imagen/not outline/logotipo/degradado/color/muzicmania_logotipo_degradado_color.svg" alt="Logotipo" fill className="object-contain" />
                    </div>
            ...
            <div className="p-12 rounded-[4rem] bg-doc-dark border-2 border-white/10 hover:border-neon-blue/30 transition-all duration-700 hover:scale-[1.01] group shadow-2xl relative overflow-hidden">
               ...
               <div className="flex flex-col lg:flex-row items-center gap-12 relative z-10">
                  <div className="flex flex-col items-center gap-4 group/img transition-transform duration-500 hover:-translate-y-2">
                     <div className="w-24 h-24 relative animate-float"><Image src="/logos/imagen/not outline/isotipo/degradado/color/muzicmania_logo_isotipo_notoutline_degradado_color.svg" alt="Isotipo" fill className="object-contain" /></div>
                     <div className="w-72 h-14 relative"><Image src="/logos/imagen/not outline/logotipo/degradado/color/muzicmania_logotipo_degradado_color.svg" alt="Logotipo" fill className="object-contain" /></div>
                  </div>
