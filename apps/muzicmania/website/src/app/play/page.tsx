                        ...
                        >
                          {Array.from({length:5}).map((_,ci)=>(
                            <span key={ci} className="flex items-center gap-3 mx-12 shrink-0 h-[85%]">
                              <img src="/logos/imagen/not outline/isotipo/degradado/color/muzicmania_logo_isotipo_notoutline_degradado_color.svg"
                                alt="" className="h-full w-auto brightness-0 invert"
                              />
                              <img src="/logos/imagen/not outline/logotipo/degradado/color/muzicmania_logotipo_degradado_color.svg"
                     ...
                     >
                      ...
                      >
                        ...
                        <div className="flex flex-col items-center justify-center px-8 text-center">
                          ...
                          >
                            <img src="/logos/imagen/not outline/isotipo/degradado/color/muzicmania_logo_isotipo_notoutline_degradado_color.svg" alt="MuzicMania" className="w-full h-full object-contain" />
                          </motion.div>
                          ...
                          >
                            <img src="/logos/imagen/not outline/logotipo/degradado/color/muzicmania_logotipo_degradado_color.svg" alt="MuzicMania" className="w-full h-full object-contain" />
                          </motion.div>
