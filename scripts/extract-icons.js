...
// Iconos extraídos del archivo navigation.tsx
const icons = {
  ...
  projects: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>`,
  about: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><circle cx="12" cy="8" r="0.5" fill="currentColor"/></svg>`,
  info: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><circle cx="12" cy="8" r="0.5" fill="currentColor"/></svg>`,
  faq: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>`,
  policies: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>`,
  ...
  certificates: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg>`,
  ...
  guidelines: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>`,
  ...
  terms: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/></svg>`,
...
const iconsDir = path.join(__dirname, '..', 'shared', 'icons', 'outline', 'svg');
...
// Guardar cada icono como archivo SVG
Object.entries(icons).forEach(([name, svg]) => {
  const filename = path.join(iconsDir, `${name}_outline.svg`);
  const svgContent = `<?xml version="1.0" encoding="UTF-8"?>
${svg.replace(/<svg/, '<svg xmlns="http://www.w3.org/2000/svg"')}`;
  
  fs.writeFileSync(filename, svgContent);
  console.log(`✓ Icono guardado: ${name}_outline.svg`);
});

console.log(`\n✅ ${Object.keys(icons).length} iconos extraídos y guardados en ${iconsDir}`);
console.log('\nNota: Estos son iconos básicos extraídos del código. Para una colección completa de 500+ iconos:');
console.log('1. Usa Iconify (https://icon-sets.iconify.design/) para descargar iconos');
console.log('2. Organízalos en outline/filled/flag según su estilo');
console.log('3. Genera versiones PNG usando herramientas como Inkscape o Figma');