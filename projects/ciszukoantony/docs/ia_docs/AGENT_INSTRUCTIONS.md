# 🤖 Instrucciones y Protocolos de Agente — Ciszuko Antony Portfolio

Este archivo contiene reglas y recordatorios para el mantenimiento del portfolio de Ciszuko Antony.
...
- `docs/ia_docs/` — Documentación para IA

## Archivos Especiales (NO automatizar DOCX/PDF)
- GUIDELINES, RULES, ACTA — Composición manual
