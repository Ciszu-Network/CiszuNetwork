 ...
 * Ciszuko Antony: orbes brand/neon desenfocados sobre el fondo negro.
 *
...
export default function PageAmbience() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute top-1/3 left-[-15%] h-[700px] w-[700px] rounded-full bg-neon-blue/5 blur-[200px]" />
      <div className="absolute bottom-[-25%] left-1/3 h-[800px] w-[800px] rounded-full bg-neon-purple/5 blur-[240px]" />
    </div>
  );
}
