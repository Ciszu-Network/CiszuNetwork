...
export default function ForumPage() {
  ...
  const categories = [
    ...
    { title: 'Soporte Técnico', desc: 'Ayuda con el portfolio, webs y servicios.', count: 42, icon: I.users, color: 'pink' },
    { title: 'Proyectos', desc: 'Colaboraciones, ideas y feedback.', count: 67, icon: I.star, color: 'cyan' },
    { title: 'Off-Topic', desc: 'Temas libres fuera del ecosistema.', count: 31, icon: I.zap, color: 'blue' },
  ];
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="blur-[15px] pointer-events-none opacity-40 select-none transition-all duration-1000 grayscale-[0.5]">
        <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[1000px] h-[1000px] bg-neon-purple/5 rounded-full blur-[200px] animate-pulse" />
        </div>
          ...
          <motion.section className="space-y-12">
            <div className="flex items-center justify-between mb-8 flex-wrap gap-6">
              <div className="relative flex-1 max-w-md group">
                <div className="absolute -inset-1 bg-gradient-to-r from-neon-purple to-brand-200 rounded-2xl blur opacity-10 group-hover:opacity-25 transition" />
      ...
      <div className="absolute inset-0 z-50 flex items-center justify-center p-6 bg-black/40">
         <motion.div 
           ...
           className="relative w-full max-w-2xl bg-black border-4 border-neon-purple/40 p-16 rounded-[5rem] text-center space-y-10 shadow-[0_0_150px_rgba(128,0,255,0.3)] backdrop-blur-3xl overflow-hidden"
         >
            {/* Animated corner glows */}
            <div className="absolute top-0 left-0 w-40 h-40 bg-neon-purple/20 rounded-full blur-[60px] animate-pulse" />
            <div className="absolute bottom-0 right-0 w-40 h-40 bg-neon-blue/20 rounded-full blur-[60px] animate-pulse" />

            <div className="relative group">
                <div className="w-32 h-32 bg-black border-4 border-neon-purple rounded-full flex items-center justify-center mx-auto text-neon-purple shadow-[0_0_40px_rgba(128,0,255,0.5)] relative z-10 animate-float">
            ...
            <div className="space-y-6 relative z-10">
               <h2 className="text-5xl md:text-7xl font-header font-black text-white uppercase italic tracking-tighter">
                 ACCESO <span className="text-neon-purple drop-shadow-neon-purple">RESTRINGIDO</span>
               </h2>
