        ...
        <div className="relative space-y-8 pt-12">
          <div className="flex flex-col items-center gap-1 text-center">
            <div className="flex items-center justify-center gap-6 group">
              <div className="w-12 h-12 text-neon-purple flex items-center justify-center">{I.globe}</div>
              <h1 className="text-4xl md:text-8xl font-header font-black uppercase tracking-tighter leading-none transition-all group-hover:tracking-normal bg-gradient-to-r from-neon-purple via-white to-brand-200 bg-clip-text text-transparent [-webkit-text-stroke:1px_black]">CONTACTO</h1>
            </div>
            <p className="text-brand-200 font-black tracking-[0.5em] uppercase text-[10px] md:text-xs">Canales oficiales de Ciszuko Antony</p>
          </div>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          <div className="lg:col-span-12 xl:col-span-5 space-y-8">
            <div className="p-10 md:p-14 bg-doc-dark border border-white/5 rounded-[3rem] space-y-8 relative overflow-hidden group">
              ...
              <h2 className="text-4xl md:text-5xl font-header font-black text-white uppercase italic tracking-tighter leading-none">CONECTA</h2>
              <p className="text-white/80 font-bold text-xl md:text-2xl leading-relaxed tracking-tight">¿Tienes un proyecto en mente? Escribe directamente a Ciszuko Antony para colaboraciones, servicios creativos o consultoría.</p>
          ...
          <div className="lg:col-span-12 xl:col-span-7">
            <div className="h-full min-h-[500px] p-4 bg-doc-dark border border-white/10 rounded-[3rem] overflow-hidden relative shadow-2xl group flex items-center justify-center">
              <div className="text-center space-y-6">
                <div className="w-20 h-20 mx-auto bg-neon-purple/10 text-neon-purple rounded-full flex items-center justify-center border border-neon-purple/20">{I.globe}</div>
                <h3 className="text-3xl font-header font-black text-white uppercase italic tracking-tighter">Respuesta prioritaria</h3>
                <p className="text-gray-400 font-bold text-sm max-w-sm mx-auto">Para proyectos grandes o alianzas comerciales, responde en menos de 24h. También por Discord.</p>
                <div className="flex flex-col gap-3 max-w-xs mx-auto">
                  <Link href="mailto:fplayersoffcial@gmail.com" className="w-full py-4 bg-neon-purple text-black rounded-2xl font-header font-black uppercase tracking-widest text-xs flex items-center justify-center gap-2 hover:scale-105 active:scale-95 transition-all">Enviar Correo</Link>
