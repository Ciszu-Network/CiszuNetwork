...
const SITE_KEYS: Record<string, string> = {
  '6LchEbAtAAAAAEVIokNOBZpCq3RFRoB_Lvabi6Aa': process.env.RECAPTCHA_SECRET_KEY_V2_CISZUKOANTONY || '',
  '6LcLErAtAAAAADfePpxJ9bGvEUC8o76LAee7Zs7Y': process.env.RECAPTCHA_SECRET_KEY_V3_CISZUKOANTONY || '',
};
