 ...
 * Español (España).
 *
 * NO es una copia: hasta ahora `'es-es': es` apuntaba al MISMO objeto, así que
 * elegir "Español España" no cambiaba absolutamente nada. Aquí van las
...
/**
 * English (UK): dialecto británico (ortografía -our/-re y -ise) más el uso de
 * minúscula en los nombres de ajuste.
 */
