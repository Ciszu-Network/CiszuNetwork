# CiszuBot — Technical Requirement Document (TRD)

Version: 1.0.0
Actualizacion: 2026-08-26
Identificador: TRD_ciszubot_PROTOCOLS_V1.0.0_2026_08_26_ciszunetwork

> **Definicion**: Requisitos tecnicos de CiszuBot.
...
- Monorepo pnpm; la web vive en `projects/ciszubot/website`.
...
- Next.js 15
- Tailwind 4
- Supabase (schema ciszubot)
- Discord.js bot (TS, pnpm, Docker)
