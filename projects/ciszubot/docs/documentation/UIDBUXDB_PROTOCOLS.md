# CiszuBot — UI/UX Design Brief

Version: 1.0.0
Actualizacion: 2026-08-26
Identificador: UIDBUXDB_ciszubot_PROTOCOLS_V1.0.0_2026_08_26_ciszunetwork

> **Definicion**: Brief de diseno UI/UX de CiszuBot.
...
- **Vibe**: tech bot, limpio. **Paleta**: violeta + cyan (bot). **Tipografia**: Inter / Space Grotesk. **Tema**: dark + light.
