...
export const metadata: Metadata = {
  ...
  description:
    'Acerca de CiszuBot: información sobre el proyecto, su creador y el ecosistema Ciszu Network.',
};
    ...
    <div className="bg-bg py-16">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-5xl font-bold text-ink">{t.aboutPage.title}</h1>
          <p className="mx-auto mt-4 max-w-2xl text-muted">{t.aboutPage.subtitle}</p>
