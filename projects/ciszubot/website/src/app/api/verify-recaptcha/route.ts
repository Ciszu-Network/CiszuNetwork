...
const SITE_KEYS: Record<string, string> = {
  '6LeSEbAtAAAAAIjOgJTSFLCJzTaPoo2nG9j3_VyS': process.env.RECAPTCHA_SECRET_KEY_V2_CISZUBOT || '',
  '6Lf-EbAtAAAAAE0f1ngpzqNKGd2RiBHyPdZlme2c': process.env.RECAPTCHA_SECRET_KEY_V3_CISZUBOT || '',
};
