...
export default function ForumPage() {
  usePageTitle('FORUM');
  const categories = [
    { title: 'General', desc: 'Charlas generales sobre CiszuBot y el ecosistema.', count: 124, icon: I.messageSquare, color: 'blue' },
    { title: 'Soporte Técnico', desc: 'Ayuda con comandos, bots y servicios.', count: 42, icon: I.users, color: 'pink' },
    { title: 'Ideas', desc: 'Propuestas para futuras versiones.', count: 67, icon: I.star, color: 'cyan' },
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
          ...
          <div className="space-y-12">
            <div className="flex items-center justify-between mb-8 flex-wrap gap-6">
              <div className="relative flex-1 max-w-md group">
                <div className="absolute -inset-1 bg-gradient-to-r from-neon-blue to-neon-cyan rounded-2xl blur opacity-10 group-hover:opacity-25 transition" />
      ...
      <div className="absolute inset-0 z-50 flex items-center justify-center p-6 bg-black/40">
         <div className="relative w-full max-w-2xl bg-black border-4 border-neon-blue/40 p-16 rounded-[5rem] text-center space-y-10 shadow-[0_0_150px_rgba(39,158,255,0.3)] backdrop-blur-3xl overflow-hidden animate-fade-in-up">
            ...
            <div className="relative group">
                <div className="w-32 h-32 bg-black border-4 border-neon-blue rounded-full flex items-center justify-center mx-auto text-neon-blue shadow-[0_0_40px_rgba(39,158,255,0.5)] relative z-10">
