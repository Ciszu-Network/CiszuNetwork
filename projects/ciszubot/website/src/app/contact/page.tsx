      ...
      <div className="max-w-7xl mx-auto px-6 pt-0 pb-32 space-y-20">
          ...
          <div className="lg:col-span-12 xl:col-span-5 space-y-8">
            <div className="p-10 md:p-14 bg-doc-dark border border-white/5 rounded-[3rem] space-y-8 relative overflow-hidden group">
              ...
              <p className="text-white/80 font-bold text-xl md:text-2xl leading-relaxed tracking-tight group-hover:text-white transition-colors">
                Establece una conexión directa con nuestro servidor de Discord. Estamos listos para sincronizar soluciones y responder a tus requerimientos globales.
              </p>
              
              <div className="pt-10 border-t border-white/5 space-y-6">
                <CopyField label="Email de Consulta Primaria" value="soporte@ciszunetwork.com" icon={I.mail} theme="blue" />
                ...
                <div className="space-y-4 pt-4">
                  <p className="text-[10px] font-black uppercase tracking-widest text-neon-purple/70 pl-2">Comando de Soporte</p>
                  <div className="grid grid-cols-1 gap-4">
                    <CopyField label="Comando Discord" value="/support" icon={I.globe} theme="purple" />
                    <CopyField label="Ticket de Soporte" value="/ticket" icon={I.mail} theme="purple" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-12 xl:col-span-7">
             <div className="h-full min-h-[500px] p-10 bg-doc-dark border border-white/10 rounded-[3rem] overflow-hidden relative shadow-2xl group">
                <div className="flex flex-col h-full justify-center items-center text-center space-y-8">
                   <div className="w-20 h-20 text-neon-purple p-5 bg-neon-purple/5 rounded-[2rem] border border-neon-purple/20">
                      {I.map}
                   </div>
                   ...
                   <div className="flex flex-wrap justify-center gap-4 pt-8">
                      <CopyField label="Email de Consulta" value="soporte@ciszunetwork.com" icon={I.mail} theme="blue" />
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} className="grid grid-cols-1 md:grid-cols-2 gap-8">
           ...
           <div className="p-10 bg-black/40 border-2 border-neon-purple/20 rounded-[3rem] space-y-6 flex flex-col items-center text-center group hover:border-neon-purple transition-all">
              <div className="w-16 h-16 text-neon-purple p-4 bg-neon-purple/5 rounded-[2rem] border border-neon-purple/20 group-hover:bg-neon-purple group-hover:text-black transition-all">
              ...
              <div className="space-y-2">
                 ...
                 <p className="text-neon-purple font-black text-xs uppercase tracking-[0.5em] opacity-80">Discord Bot Architecture</p>
              </div>
              <div className="flex flex-wrap justify-center gap-2">
                 {['Discord.js', 'Node.js', 'Supabase', 'TypeScript', 'Slash Commands', 'Event System'].map(tech => (
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} className="relative py-12">
            <div className="flex flex-col md:flex-row items-center gap-12 p-12 bg-gradient-to-br from-indigo-950/40 to-black border-2 border-neon-purple/30 rounded-[4rem] relative overflow-hidden group hover:border-neon-blue transition-all duration-700">
               <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_50%,rgba(168,85,247,0.15)_0%,transparent_60%)] pointer-events-none" />
               <div className="w-48 h-48 md:w-64 md:h-64 bg-black border-2 border-neon-purple/30 rounded-[4rem] shrink-0 transform rotate-6 group-hover:rotate-0 transition-transform duration-700 shadow-2xl overflow-hidden flex items-center justify-center p-12 text-white">
                  {I.user}
               </div>
           ...
           <div className="space-y-16">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                   <div className="h-[1px] flex-1 bg-neon-purple/10" /><span className="text-neon-purple font-black text-[10px] uppercase tracking-widest px-4">Ecosistema CiszuBot</span><div className="h-[1px] flex-1 bg-neon-purple/10" />
                </div>
