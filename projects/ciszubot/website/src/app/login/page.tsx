    ...
    <div className="bg-bg min-h-[calc(100vh-60px)] relative overflow-hidden pb-24">
      ...
      <div className="max-w-md mx-auto px-4 pt-14 relative">
        <div className="text-center mb-8">
          <div className="w-12 h-12 mx-auto text-neon-blue flex items-center justify-center drop-shadow-[0_0_15px_rgba(0,212,255,0.4)]">
            {I.login}
          </div>
          <h1 className="mt-3 text-4xl md:text-5xl font-header font-black uppercase tracking-tighter bg-gradient-to-r from-[#5865F2] to-neon-blue bg-clip-text text-transparent">
            Acceso
          </h1>
          <p className="mt-2 text-neon-blue font-black tracking-[0.4em] uppercase text-[10px] md:text-xs">
            Bienvenido de nuevo a CiszuBot
          </p>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="relative p-6 md:p-8 bg-surface border border-border rounded-[2rem] shadow-2xl space-y-6 backdrop-blur-3xl">
            ...
            <div className="pt-4 border-t border-border text-center flex flex-col gap-2.5">
              <p className="text-[10px] text-faint font-bold uppercase tracking-[0.2em]">
                ¿Sin cuenta?{' '}
                <Link href="/register" className="text-neon-blue hover:text-white transition-colors underline decoration-neon-blue/30 underline-offset-8">
                  Regístrate aquí
                </Link>
              </p>
              <p className="text-[10px] text-faint font-bold uppercase tracking-[0.2em]">
                ¿Problemas de acceso?{' '}
                <Link href="/soporte" className="text-muted hover:text-white transition-colors underline decoration-white/20 underline-offset-8">
                  Contacta soporte
                </Link>
              </p>
            </div>
