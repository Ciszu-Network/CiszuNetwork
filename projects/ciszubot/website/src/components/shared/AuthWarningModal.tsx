...
export default function AuthWarningModal({ isOpen, onClose, message }: AuthWarningModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-sm bg-black border-2 border-neon-red/30 p-10 rounded-[3rem] text-center space-y-8 shadow-[0_0_80px_rgba(255,0,0,0.15)] animate-fade-in-up">
