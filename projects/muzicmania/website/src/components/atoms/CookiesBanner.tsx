  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <div className="pointer-events-auto max-w-4xl mx-auto bg-black/90 backdrop-blur-xl border-t border-neon-cyan/30 md:border md:rounded-[2rem] p-6 shadow-[0_0_40px_rgba(0,212,255,0.15)] flex flex-col md:flex-row items-center gap-6 justify-between">
