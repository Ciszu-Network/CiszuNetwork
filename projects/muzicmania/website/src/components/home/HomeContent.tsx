...
import { Icon, SmartImage, useToast, EcosystemSection } from '@ciszu/ui';
  ...
  return (
    <div onClick={handleStartMusic} className="cursor-default min-h-screen">
      ...
      <EcosystemSection
        ...
        description="MuzicMania is part of the Ciszu Network ecosystem. Discover more projects and tools built by Ciszuko Antony."
