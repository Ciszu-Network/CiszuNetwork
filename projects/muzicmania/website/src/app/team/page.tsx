...
const I = {
  ...
  nextjs:      <img src={resolveAssetPath('projects/muzicmania/content/logos/images/tech/nextjs.svg')} alt="Next.js" className="w-full h-full object-contain" />,
  typescript:  <img src={resolveAssetPath('projects/muzicmania/content/logos/images/tech/typescript.svg')} alt="TypeScript" className="w-full h-full object-contain" />,
