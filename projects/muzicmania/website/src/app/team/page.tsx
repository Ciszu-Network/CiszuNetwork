...
const I = {
  ...
  nextjs:      <img src="/tech/nextjs.svg" alt="Next.js" className="w-full h-full object-contain" />,
  typescript:  <img src="/tech/typescript.svg" alt="TypeScript" className="w-full h-full object-contain" />,
