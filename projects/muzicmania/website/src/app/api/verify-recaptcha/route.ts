...
const SITE_KEYS: Record<string, string> = {
  '6LeKRPEsAAAAADPIRSjuEYFI0idQP0c6CQCaeYik': process.env.RECAPTCHA_SECRET_KEY_V2_MUZIC || '',
  '6LcCErAtAAAAAGuSmdDMuXtybWmxgTqOxcfk-nFo': process.env.RECAPTCHA_SECRET_KEY_V3_MUZIC || '',
};
