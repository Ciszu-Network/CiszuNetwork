...
{ id: 15, title: "DATOS PARA RECOMENDACIÓN DE ANUNCIOS", content: "Para recomendar mejores anuncios, MuzicMania puede usar señales de audiencia agregadas (páginas visitadas, idioma del navegador, región aproximada) recogidas por Google Analytics 4. Estos datos se tratan de forma agregada y anónima; no se utilizan para identificar a una persona concreta más allá de lo necesario para el servicio. Puedes bloquear las cookies de análisis desde tu navegador o desde las preferencias del sitio." },
{ id: 16, title: "GEOLOCALIZACIÓN", content: "Podemos estimar tu ubicación aproximada (región/país) a partir de tu dirección IP para: (1) ofrecer contenido y anuncios relevantes a tu región, (2) cumplir requisitos legales locales y (3) mejorar la seguridad (detección de accesos sospechosos). La geolocalización precisa (GPS) solo se utiliza si una funcionalidad lo requiere explícitamente y con tu consentimiento; nunca se usa para anuncios." },
{ id: 17, title: "CUENTAS Y REGISTRO", content: "La creación de cuentas (CISZU ID) es opcional y sirve para sincronizar tu progreso, perfil y preferencias entre los servicios del ecosistema. Al crear una cuenta aceptas estos términos, eres responsable de mantener la confidencialidad de tus credenciales y de la actividad realizada con tu cuenta. Puedes eliminar tu cuenta contactándonos; los datos asociados se suprimirán salvo retención legal." },
  { id: 18, title: "COMUNICACIONES OFICIALES Y SOPORTE", content: "Toda notificación oficial respecto a estos términos se realizará mediante el canal general de Discord o la sección de anuncios en la web oficial. El soporte legal se gestionará únicamente vía correo electrónico corporativo." },
  { id: 19, title: "RESEÑAS Y CALIFICACIONES", content: "Las calificaciones públicas de MuzicMania incorporan una reseña base fantasma de 5.0 para reflejar un estándar de calidad objetivo. Cuando no existen reseñas reales de usuarios, se muestra 5.0 y se indica expresamente que no hay reseñas para analizar. Cuando existen reseñas reales, la calificación pública es la media aritmética entre las reseñas de usuarios y la reseña base 5.0. No se falsifican reseñas: todas las reseñas visibles son reales o, en su defecto, se muestra el estado de 'sin reseñas'." },
];
