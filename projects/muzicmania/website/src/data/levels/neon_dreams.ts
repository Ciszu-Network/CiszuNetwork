...
export const config: LevelConfig = {
  ...
  files: {
    audio: assetResolver.resolve('projects/muzicmania/content/music/albums/genesis_neon/neon_dreams/neon_dreams.ogg'),
    banner: assetResolver.resolve('projects/muzicmania/content/music/albums/genesis_neon/neon_dreams/banner.png'),
    disc: assetResolver.resolve('projects/muzicmania/content/music/albums/genesis_neon/neon_dreams/disc.svg'),
  },
  stats: {
    plays: 1250,
    downloads: 450,
