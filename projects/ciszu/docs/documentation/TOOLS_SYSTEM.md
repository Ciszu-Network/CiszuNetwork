# TOOLS_SYSTEM — Herramientas de Desarrollo, Productividad y Creatividad

Versión: 3.0.0
Actualización: 2026-09-05
Identificador: TOOLS_SYSTEM_V3.0.0_2026_09_05_ciszunetwork

> **Definición**: sistema de herramientas del ecosistema: desarrollo (DBeaver, dbvr, Bruno, Fork),
> productividad/creatividad (Figma, Canva, Miro, Todoist, Slack, ChatGPT, Gemini) y reglas de uso
...
## 3. Herramientas de productividad, creatividad y comunicación

Criterio de selección: **sin tarjeta en plan free, sin solapamiento innecesario con el stack técnico,
y con cuenta oficial de Ciszu Network cuando aplique**.

| # | Herramienta | Categoría | Uso oficial | Acceso / notas |
|---|---|---|---|---|
| 1 | **Figma** | Diseño UI/UX | Diseño de componentes, tokens, prototipado y assets visuales del ecosistema | Cuenta oficial de Ciszu Network; ver `UI_COMPONENTS_SYSTEM.md` §7 y `PACKAGES_SYSTEM.md` §4 |
| 2 | **Canva** | Diseño rápido | Banners, posts, presentaciones y contenido multimedia | Cuenta oficial de Ciszu Network |
| 3 | **Miro** | Whiteboards | Mapas mentales, flujos, lluvia de ideas y planificación visual | Cuenta oficial de Ciszu Network |
| 4 | **Todoist** | Tareas | Gestión de pendientes personales y seguimiento de tareas | Cuenta oficial de Ciszuko Antony |
| 5 | **Slack** | Comunicación | Canales por proyecto, notificaciones y coordinación interna | Cuenta oficial de Ciszu Network |
| 6 | **ChatGPT** | IA general | Redacción, documentación, soporte, brainstorming y revisión de texto | Cuenta OpenAI oficial; complementa el stack de modelos (ver `MODELS_LLM_SYSTEM.md`) |
| 7 | **Gemini** | IA multimodal | Normalización de voz, generación de imagen y tareas de texto ligeras | API key propia en vault (`GEMINI_API_KEY`); ver `OPENCODE_SYSTEM.md` y `MODELS_LLM_SYSTEM.md` |
| 8 | **Google Alerts** | Monitoreo de marca | Alertas automáticas por email de menciones de "Ciszu Network", "Ciszuko Antony", "MuzicMania", "CiszuBot" | https://www.google.com/alerts; cuenta Google del usuario; ver `SEO_PLAN.md` §2.3.1 |
| 9 | **Google Trends** | Tendencias de búsqueda | Comparar interés temporal de keywords (ej. "juego ritmo", "bot Discord", "portfolio dev") | https://trends.google.com; gratis, sin API; ver `SEO_PLAN.md` §2.3.2 |
| 10 | **Google Keyword Planner** | Keywords SEO/PPC | Volumen, competencia y CPC estimado para investigación de keywords | https://ads.google.com/aw/keywordplanner; requiere cuenta Ads (`ca-pub-3471969072198962`); ver `SEO_PLAN.md` §2.3.3 |

**Regla**: estas herramientas no reemplazan el stack técnico (BD, API, hosting). Se suman para
productividad, diseño y comunicación. No se instalan por CLI en el repo; su acceso es por cuenta
web/desktop oficial.
...
## 8. Documentación oficial de referencia
...
- ✅ **Figma, Canva, Miro, Todoist, Slack, ChatGPT, Gemini** incorporados como herramientas oficiales de productividad/creatividad/comunicación del ecosistema (5 sep 2026). Documentadas en `ONLINE_SERVICES_SYSTEM.md` §5 y en este doc §3. Cuentas oficiales de Ciszu Network donde aplique.
...
| **Figma** | Cuenta oficial | Diseño UI/UX, prototipado y tokens del ecosistema |
| **Canva** | Cuenta oficial | Diseño rápido de assets, banners y contenido multimedia |
| **Miro** | Cuenta oficial | Whiteboards colaborativos, mapas mentales y flujos |
| **Todoist** | Cuenta oficial | Gestión de tareas personales y pendientes |
| **Slack** | Cuenta oficial | Comunicación interna y canales por proyecto |
| **ChatGPT** | Cuenta OpenAI | Asistencia IA en redacción, documentación y brainstorming |
| **Gemini** | API key en vault | Voz, generación de imagen y tareas de texto |
...
_Última revisión: 5 sep 2026._ Relacionado: `DB_SYSTEM.md`, `WORKFLOW_SYSTEM.md`,
`FULL_STACK_SYSTEM.md`, `KNOWLEDGE_SYSTEM.md`, `STATUS_SYSTEM.md`, `CIBERSECURITY_SYSTEM.md`,
`ONLINE_SERVICES_SYSTEM.md`, `MODELS_LLM_SYSTEM.md`, `UI_COMPONENTS_SYSTEM.md`, `PACKAGES_SYSTEM.md`.
