# AUTH_SYSTEM — Plan de autenticación (Auth Roadmap) — Ciszu Network

Versión: 2.0.0
Actualización: 2026-08-13
Identificador: AUTH_SYSTEM_V2.0.0_2026_08_13_ciszunetwork
...
## Endurecimiento (19 sep 2026)

El detalle del 2FA por email (`C-123 434`), la recuperación de contraseña
(motivo del fallo, no reutilizar la anterior, sesión temporal, límite de 12 h),
reCAPTCHA v2+v3 en los registros y el enlace obligatorio de re-login están en
**`AUTH_HARDENING_SYSTEM.md`**. Ahí también está la causa raíz de los fallos y
los scripts que generan las 4 webs desde una única plantilla.
