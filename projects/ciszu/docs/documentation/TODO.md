...
- [ ] Los quickdocks siempre deben estar abajo del contenido de la pagina body, nunca arriba al principio. En ciszubot terminos y politicas ocurre esto.
...
- [ ] Terminar idiomas en ingles (UK y USA) por separado.
- [ ] Terminar bien el tema claro (Todos los docks, modals o cards con fondo oscuro paran a claro, los textos oscuros o negros e iconos negros o oscuros.)
- [ ] Censurar certificado de bachillerato y datos sensibles como la decula, reactualizar las imagenes preview y CDN. He creado y renombrado los archivos, diploma_certificado_bachillerato_monseñorcastro_censored y diploma_certificado_bachillerato_monseñorcastro_uncensored, el que se debe debe utilizar es el que tiene el termino censored. NUNCA el de uncensored. El uncensored lo tengo en mi PC local, nunca se subira al CDN. En caso de que este borralo (y borra tambien cualquier rastro del anterior archivo del certificado de bachillerato que esta leaked nombrado dato 35 o uncensored)
