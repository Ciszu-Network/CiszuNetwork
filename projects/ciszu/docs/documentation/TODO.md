...
## Arreglar vulnerabilidades de GH:

- [ ] Select alert: js-yaml: YAML merge-key chains can force quadratic CPU consumption

    [js-yaml: YAML merge-key chains can force quadratic CPU consumption](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot/48) [High](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot?q=is%3Aopen+severity%3Ahigh 'Severity: high') [Development](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot?q=is%3Aopen+scope%3Adevelopment)

    #48 opened 13 hours ago • Detected in js-yaml (npm) • pnpm-lock.yaml

- [ ] Select alert: JS-YAML: Quadratic CPU consumption in !!omap resolution (3.x and 4.x) — CVE-2026-59870 fix not backported

    [JS-YAML: Quadratic CPU consumption in !!omap resolution (3.x and 4.x) — CVE-2026-59870 fix not backported](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot/49) [High](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot?q=is%3Aopen+severity%3Ahigh 'Severity: high') [Development](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot?q=is%3Aopen+scope%3Adevelopment)

    #49 opened 13 hours ago • Detected in js-yaml (npm) • pnpm-lock.yaml

- [ ] Select alert: js-yaml has prototype pollution in merge (<<)

    [js-yaml has prototype pollution in merge (&lt;&lt;)](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot/46) [Moderate](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot?q=is%3Aopen+severity%3Amoderate 'Severity: moderate') [Development](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot?q=is%3Aopen+scope%3Adevelopment)

    #46 opened 13 hours ago • Detected in js-yaml (npm) • pnpm-lock.yaml

- [ ] Select alert: JS-YAML: Quadratic-complexity DoS in merge key handling via repeated aliases

    [JS-YAML: Quadratic-complexity DoS in merge key handling via repeated aliases](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot/47) [Moderate](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot?q=is%3Aopen+severity%3Amoderate 'Severity: moderate') [Development](https://github.com/Ciszu-Network/CiszuNetwork/security/dependabot?q=is%3Aopen+scope%3Adevelopment)

    #47 opened 13 hours ago • Detected in js-yaml (npm) • pnpm-lock.yaml
