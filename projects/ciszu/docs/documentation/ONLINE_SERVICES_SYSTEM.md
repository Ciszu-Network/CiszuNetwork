...
Identificador: ONLINE_SERVICES_SYSTEM_V2.1.0_2026_09_05_ciszunetwork
...
## 5. Productividad, creatividad y diseño

| Servicio | Uso | Estado |
|---|---|---|
| **Figma** | Diseño UI/UX, prototipado, tokens y componentes visuales del ecosistema | ✅ Activo |
| **Canva** | Diseño rápido de assets, banners y contenido multimedia | ✅ Activo |
| **Miro** | Whiteboards colaborativos, lluvia de ideas, mapas mentales y flujos | ✅ Activo |
| **Todoist** | Gestión de tareas personales y seguimiento de pendientes | ✅ Activo |
| **Slack** | Comunicación interna, canales por proyecto y notificaciones | ✅ Activo |
| **ChatGPT** | Asistencia IA en redacción, documentación, soporte y brainstorming | ✅ Activo |
| **Gemini** | IA multimodal: normalización de voz, generación de imagen y tareas de texto | ✅ Activo |
...
| Figma | Activo | Diseño UI/UX y tokens |
| Canva | Activo | Diseño rápido de assets |
| Miro | Activo | Whiteboards colaborativos |
| Todoist | Activo | Gestión de tareas |
| Slack | Activo | Comunicación interna |
| ChatGPT | Activo | Asistencia IA general |
| Gemini | Activo | Voz y generación de imagen |
...
| Soporte/comunicación | Email Gmail/Outlook, WhatsApp, Discord de la comunidad, Slack |
| Productividad/creatividad | Figma, Canva, Miro, Todoist, ChatGPT, Gemini |
...
- `MODELS_LLM_SYSTEM.md` — historial y facturación de modelos LLM (Gemini, ChatGPT).
- `UI_COMPONENTS_SYSTEM.md` / `PACKAGES_SYSTEM.md` — integración de Figma en Storybook.
...
_Última revisión: 5 sep 2026._ Relacionado: `CONTACTS_PROTOCOLS.md`, `VAULT_SYSTEM.md`,
`ANALYTICS_SYSTEM.md`, `MONITORING_SYSTEM.md`, `PAYMENTS_SYSTEM.md`, `FULL_STACK_SYSTEM.md`,
`MODELS_LLM_SYSTEM.md`, `UI_COMPONENTS_SYSTEM.md`, `PACKAGES_SYSTEM.md`.
