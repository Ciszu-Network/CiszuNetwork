...
| **CiszuGamens** | `projects/ciszugamens` | Comunidad gaming + Discord server + Landing Next.js 15 | ciszugamens.vercel.app (por crear) | `ciszugamens-website` |
...
- **Filtro pnpm:** `ciszugamens-website`
- **URL:** ciszugamens.vercel.app (landing por desplegar)
- **Framework:** Next.js 15 (App Router) + Tailwind v4
- **Discord:** https://discord.gg/W3kMtMMj6E (servidor activo)
- **Discord Bot List:** https://discordbotlist.com/servers/ciszugamens
- **Estado:** ✅ Comunidad activa — Landing web en desarrollo (Fase 1)
- **Ads:** `source: 'ciszugamens'` en `@ciszu/ui/Ads.tsx` (acento cian #22d3ee)
- **CDN:** Assets en `ciszu-cdn` bucket (5 logos + 1 banner)
- **Docs:** `projects/ciszugamens/docs/` multi-formato + `documentation/` completa
- **Integración:** Sistema de anuncios, GA4/GTM/AdSense, CDN, Discord webhook
