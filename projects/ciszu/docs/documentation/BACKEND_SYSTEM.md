...
| **Chromatic** | **Añadido (F4, dev-only)** en `@ciszu/ui` (`chromatic` CLI 18.2) | Visual + accessibility testing de Storybook (builds 1–5, 14 ago 2026; 5 stories/2 componentes; builds 4–5 publicados localmente por billing). Addon `@storybook/addon-a11y` 10.5.8 + tags `a11y`. Token `CHROMATIC_PROJECT_TOKEN` en vault; script `chromatic`; CI `.github/workflows/chromatic.yml`. appId `6a7f722e2641a24bc6249782`. |
