...
Identificador: BACKEND_SYSTEM_V1.0.0_2026_08_13_ciszunetwork
...
> cómo están organizados los esquemas, cómo se protege el acceso (RLS) y cómo se consumen
> desde las webs/bot.
...
| **Webhooks/IPN** | HTTP callbacks | Pagos NOWPayments, notificaciones |
...
_Última revisión: 13 ago 2026._ Relacionado: `DB_SYSTEM.md`, `CDN_SYSTEM.md`,
`AUTH_SYSTEM.md`, `SECURITY_PROTOCOLS.md`, `FRAMEWORKS_SYSTEM.md`.
