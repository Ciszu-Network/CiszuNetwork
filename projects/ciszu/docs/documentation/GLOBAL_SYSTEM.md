# GLOBAL_SYSTEM — Sistema Global y Flujo de Trabajo (Ciszu Network)

Versión: 2.0.0
Actualización: 2026-08-26
Identificador: GLOBAL_SYSTEM_V2.0.0_2026_08_26_ciszunetwork

> **Definición**: sistema global del ecosistema (antiguo WORKFLOW_SYSTEM): operación diaria del
> monorepo, comandos, pipelines, convenciones git, CI/CD y protocolos de equipo. Además del
> flujo de trabajo técnico, describe el **workflow por website** (cómo actúa cada página,
> landing y sitemap; detalle en `WORKFLOW_APP_PROTOCOLS` de cada web). Tarea `TODO.md #7`.

## Workflow por website

| Web | Docs de workflow de la app |
|---|---|
| Ciszu Network | `projects/ciszu/docs/documentation/` → `WORKFLOW_APP_PROTOCOLS.md` |
| Ciszuko Antony | `projects/ciszukoantony/docs/documentation/` → `WORKFLOW_APP_PROTOCOLS.md` |
| CiszuBot | `projects/ciszubot/docs/documentation/` → `WORKFLOW_APP_PROTOCOLS.md` |
| MuzicMania | `projects/muzicmania/docs/documentation/` → `WORKFLOW_APP_PROTOCOLS.md` |
