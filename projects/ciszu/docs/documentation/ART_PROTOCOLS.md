# ART_PROTOCOLS — Protocolos Oficiales de Arte (Biblia Artística CISZU NETWORK)

Versión: 2.0.0
Actualización: 2026-08-13
Identificador: ART_PROTOCOLS_V2.0.0_2026_08_13_ciszunetwork

> **Estatus**: protocolo oficial vinculante del pipeline artístico de Ciszu Network. Norma
> técnica obligatoria para todo activo visual (MuzicMania, logos, banners, portadas) producido
> por humanos o IA. No es una guía sugerida: su incumplimiento invalida el activo en QA.
...
- `solid color horizontal background stripe` (estándar ART_PROTOCOLS; franja plana, fácil chroma, mejor con BiRefNet)
