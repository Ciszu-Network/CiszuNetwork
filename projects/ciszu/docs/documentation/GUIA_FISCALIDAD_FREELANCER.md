# Guía: Fiscalidad de Persona Natural (Freelancer Digital en Venezuela)

**Fecha: 10 ago 2026**. Obligaciones fiscales de **Ciszuko Antony (persona natural)** al
facturar servicios digitales desde Venezuela: ISLR, IVA, IGTF, facturación digital y libros.
Todo pagable en **efectivo/Bs./divisas — sin tarjeta de crédito**.
...
## 1. Impuestos que aplican (persona natural)

| Impuesto | Base | Tasa | Cuándo |
| --- | --- | --- | --- |
| **ISLR** (Impuesto Sobre la Renta) | Enriquecimiento neto anual (ingresos − gastos deducibles) | Escala progresiva (consultar vigente; tramo exento por debajo de cierto umbral en UT) | Declaración anual definitiva (1 ene–31 mar del año siguiente) |
| **IVA** (16%) | Ventas de bienes/servicios gravados | 16% | Declaración mensual (Formulario...); **exportación de servicios: 0%** si aplican las normas de exportación de servicios (servicios digitales a clientes del exterior suelen calificar) |
...
| **Retenciones** | ISLR e IVA que te retienen tus clientes jurídicos | Según tabla | Acreditar contra la declaración anual |
...
## 2. Facturación digital (obligatoria desde marzo 2025)
...
## 3. Libros y registros recomendados (persona natural)
