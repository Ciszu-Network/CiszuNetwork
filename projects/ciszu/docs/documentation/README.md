...
### Planes
`COMPANY_REGISTRATION_PLAN.md` · `RIF_PERSON_PLAN.md` · `COMMERCIAL_REGISTRATION_PLAN.md` · `INTERNATIONAL_LLC_PLAN.md` · `TAX_PLAN.md` · `TRADEMARK_PLAN.md` · `ORGANIZATIONAL_SCALABILITY_PLAN.md` · `RAG_VECTORS_PLAN.md` · `AI_ART_PLAN.md` · `VPS_PLAN.md` · `TOOLS_EVALUATION_PLAN.md` (evaluación de servicios/herramientas candidatas) · `INSTALLERS_SYSTEM.md` · `PRD_GLOBAL_SYSTEM.md` (Product Requirement Document global) · `TRD_GLOBAL_SYSTEM.md` (Technical Requirement Document global) · `UIDBUXDB_GLOBAL_SYSTEM.md` (UI/UX Design Brief global) · `BACKEND_SCHEMA_GLOBAL_SYSTEM.md` (backend + schema global) · `IMPLEMENTATION_PLAN_GLOBAL_SYSTEM.md` (plan de implementación global)

### Protocolos
`SECURITY_PROTOCOLS.md` · `CODE_PRINCIPLES_PROTOCOLS.md` · `IT_GLOSSARY_PROTOCOLS.md` · `GEOGRAPHIC_CONTEXT_PROTOCOLS.md` · `HISTORICAL_CONTEXT_PROTOCOLS.md` · `TARGET_AUDIENCE_PROTOCOLS.md` · `HEALTH_AND_SAFETY_PROTOCOLS.md` · `SCHEDULE_PROTOCOLS.md` · `CONTACTS_PROTOCOLS.md` · `MATERIAL_ICONS_PROTOCOLS.md` · `ART_PROTOCOLS.md` · `DEVSECOPS_SYSTEM.md` · `ONLINE_SERVICES_SYSTEM.md` · `MONETIZATION_PROTOCOLS.md` (monetización: donaciones directas/indirectas, anuncios, compras y suscripciones futuras)
...
_Última revisión: 16 sep 2026._ Relacionado: `DOCUMENTATION_SYSTEM.md`, `AGENTS.md`.
