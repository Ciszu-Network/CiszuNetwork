...
### Docker
- `docs/ia_docs/DOCKER.md` (guía + limitaciones honestas), `docker-compose.yml` (ciszu-bot + supabase-local con profile), `projects/ciszubot/Dockerfile` (node:20-alpine, no-root), `.dockerignore`, `projects/ciszubot/.env.example`.
