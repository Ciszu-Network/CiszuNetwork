...
- Website: Next.js 15
- Bot: Node.js
- Filter: `ciszubot-website` (website), `ciszubot` (bot)

## CiszuGamens (ciszugamens/)
Gaming community/Discord server. Standalone project outside projects/.
- Focus: tournaments, events, community management
- Has its own documentation structure

## Ciszuko Antony (ciszukoantony/)
Personal brand / content creator identity. Standalone outside projects/.
