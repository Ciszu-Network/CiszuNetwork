    ...
    <div className="min-h-screen pt-24 pb-20 relative">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-0 pb-32 space-y-12">
            ...
            <div className="flex items-center justify-center gap-14 relative z-10 text-center flex-wrap">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="mt-2 inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-gradient-to-r from-neon-yellow to-neon-blue text-black font-header font-black uppercase tracking-widest text-xs shadow-lg hover:scale-105 active:scale-95 transition-all"
                >
                  Escribir reseña
                </button>
              </div>
            ...
            <div className="w-full">
              <div className="flex flex-wrap items-center justify-center gap-3">
                <button
                  ...
                  className="h-10 w-10 rounded-full border border-white/10 bg-white/5 text-white/70 hover:border-neon-yellow/30 hover:text-neon-yellow disabled:opacity-30 flex items-center justify-center transition-all"
                >
                  ‹
                </button>
                {buildDots().map((p, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`h-10 min-w-[40px] rounded-full border text-xs font-black uppercase tracking-widest transition-all ${isActive ? 'bg-neon-yellow text-black border-neon-yellow' : 'bg-white/5 border-white/10 text-white/70 hover:border-neon-yellow/30 hover:text-neon-yellow'}`}
                    >
                      {pageIdx + 1}
                    </button>
                  );
        ...
        <motion.section initial="hidden" animate="visible" variants={sectionVariants} className="grid grid-cols-1 gap-10">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-8">
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl border text-xs font-header font-black uppercase tracking-widest transition-all bg-white/5 border-white/10 text-white/70 hover:border-neon-yellow/30 hover:text-neon-yellow"
                      >
          ...
          {reviews.length === 0 && (
            <div className="p-14 rounded-[4rem] bg-black border-2 border-dashed border-neon-blue/25 text-center space-y-5">
              <div className="w-16 h-16 mx-auto text-neon-yellow/50">{I.star('good')}</div>
              <h2 className="text-3xl font-header font-black text-white uppercase tracking-tighter">Ninguna reseña subida aún</h2>
              <p className="text-white/40 text-sm font-black uppercase tracking-widest">Sé el primero en reseñar Ciszunetwork.</p>
              <button
                type="button"
                onClick={() => handleActionRequiresAuth('publicar una reseña')}
                className="inline-flex items-center gap-2 px-7 py-3 rounded-2xl bg-neon-yellow text-black font-header font-black uppercase tracking-widest text-xs hover:scale-105 active:scale-95 transition-all"
              >
        ...
        <motion.section initial="hidden" animate="visible" variants={sectionVariants} className="space-y-12 pt-12">
          <div className="p-8 rounded-[3rem] bg-gradient-to-br from-neon-blue/10 via-transparent to-transparent border border-neon-blue/25 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-6">
              ...
              <div className="px-6 py-3 rounded-2xl bg-black border-2 border-neon-purple/30 text-neon-purple font-header font-black text-sm uppercase tracking-widest shadow-[0_0_25px_rgba(168,85,247,0.15)]">
                Discord Server
              </div>
            </div>
