              ...
              {related.map((rel) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-sm font-header font-black text-white uppercase italic tracking-tighter leading-tight group-hover:text-brand-accent transition-colors">
                      {rel.title}
                    </span>
