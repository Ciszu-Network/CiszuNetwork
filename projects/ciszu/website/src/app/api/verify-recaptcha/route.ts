...
const handler = createRecaptchaHandler({
  v2Secret: process.env.RECAPTCHA_SECRET_KEY_V2_CISZU ?? process.env.RECAPTCHA_SECRET_KEY_V2 ?? '',
  v3Secret: process.env.RECAPTCHA_SECRET_KEY_V3_CISZU ?? process.env.RECAPTCHA_SECRET_KEY_V3 ?? '',
  minScore: 0.5,
  windowMs: 60_000,
  max: 30,
