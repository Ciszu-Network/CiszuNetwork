...
export const DOCS_METADATA: Record<string, DocMetadata> = {
  ABOUT: {
    ...
    description: 'La visión, valores y filosofía detrás de Ciszu Network.',
    icon: 'globe',
    category: 'info',
  ...
  GUIDELINES: {
    ...
    description: 'Guía técnica para optimizar tu experiencia en la red.',
    icon: 'compass',
    category: 'support',
    lastUpdate: '2026-09-18',
    author: 'Ciszuko Antony',
  ...
  STATS: {
    title: 'Estadísticas del Ecosistema',
    description: 'Interpretación de métricas y rendimiento global.',
    icon: 'barChart',
    category: 'info',
    lastUpdate: '2026-09-18',
    author: 'Ciszuko Antony',
  ...
  TERMS_AND_CONDITIONS: {
    ...
    description: 'El contrato legal entre tú y Ciszu Network.',
    icon: 'bookOpen',
    category: 'legal',
    lastUpdate: '2026-09-18',
    author: 'Ciszuko Antony',
