...
export const Button: FC<ButtonProps> = ({
  ...
  const baseStyles =
    'inline-flex items-center justify-center font-header font-bold rounded-xl transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none';
