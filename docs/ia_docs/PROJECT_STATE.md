...
**Framework:** Next.js 15 (App Router)
**Estado:** ✅ Activo
**Docs:** apps/ciszukoantony/docs/ — 16 txt, 16 md, 15 docx, 16 pdf, 11 ia_docs
**public/docs/:** ✅ Creado
...
**Docs:** apps/muzicmania/docs/ — 22 txt, 22 md, 16 docx, 16 pdf, 19 ia_docs (referencia)
...
**Docs:** apps/ciszubot/docs/ — 18 txt, 18 md, 17 docx, 17 pdf, 11 ia_docs
...
2. **Bot Discord**: apps/ciszubot/discord/ no existe aún
