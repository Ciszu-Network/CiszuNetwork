...
Estado real (5 ago 2026): `tools/video-ai/generate-video.js` implementado. Provider **fal** directo
...
Flujo:
1. Lee `tools/README.md` (sección "Vídeo") y `tools/video-ai/generate-video.js`.
2. Ejecuta:
