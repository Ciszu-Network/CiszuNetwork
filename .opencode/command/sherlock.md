...
```powershell
& "E:\Ciszu Network\tools\osint\sherlock.ps1" -Usernames <user1>,<user2> [-Preset full|quick] [-Test] [-Out ruta]
```

- **full** (default): `--csv --timeout 30`
- **quick**: `--csv --timeout 15`
- Salida oficial: `tools/osint/output/sherlock/` · Test: `test/osint/sherlock/` (gitignored)
