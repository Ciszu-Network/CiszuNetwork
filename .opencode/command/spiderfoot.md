...
```powershell
& "E:\Ciszu Network\tools\cibersecurity\osint\spiderfoot.ps1" -Targets <target1>,<target2> [-Preset full|quick] [-Test] [-Out ruta]
```
...
- Salida oficial: `tools/cibersecurity/osint/output/spiderfoot/` · Test: `test/osint/spiderfoot/` (gitignored)
